    ...
    return Column(
      children: [
        ...
        Container(
          ...
          padding: const EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
          child: Text(widget.alldata[i]['revenue'].toString(),
        ...
        Container(
          ...
          padding: const EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
          child: Text(widget.alldata[i]['ebitda'].toString(),
              style: const TextStyle(fontWeight: FontWeight.w400)),
        ),
        Container(
          width: width,
        ...
        Container(
          ...
          padding: const EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
          child: Text(widget.alldata[i]['netIncome'].toString(),
              style: const TextStyle(fontWeight: FontWeight.w400)),
        ),
        Container(
          width: width,
          ...
          padding: const EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
          child: Text(widget.alldata[i]['eps'].toString(),
              style: const TextStyle(fontWeight: FontWeight.w400)),
        ),
        Container(
          width: width,
