...
class CustomTable3 extends StatefulWidget {
  ...
  @override
  State<CustomTable3> createState() => _CustomTable3State();
}

class _CustomTable3State extends State<CustomTable3> {
  @override
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          padding: const EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
          child: Text(widget.alldata[i]['netChangeInCash'].toString(),
        ...
        Container(
          ...
          padding: const EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
          child: Text(widget.alldata[i]['changeInWorkingCapital'].toString(),
              style: const TextStyle(fontWeight: FontWeight.w400)),
        ),
        Container(
          width: width,
          ...
          padding: const EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
          child: Text(widget.alldata[i]['capitalExpenditure'].toString(),
              style: const TextStyle(fontWeight: FontWeight.w400)),
        ),
        Container(
          width: width,
          ...
          padding: const EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
          child: Text(widget.alldata[i]['freeCashFlow'].toString(),
              style: const TextStyle(fontWeight: FontWeight.w400)),
        ),
      ],
    );
